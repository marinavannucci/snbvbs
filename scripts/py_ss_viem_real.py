...
for seed in range(0, 100):
    ...
    model = NegBinSSVIEM(seed)
    model.set_data(Xtrain, Ytrain)
    model.set_prior(0.01, 0.01, 4, p, 1, 10)  # set prior on over-dispersion parameter r
    ...
    neg_bin_simu = {"beta": beta, "gamma": gamma, "beta0": beta0, "r": r, "time": time,
                    ...
                    "m": m, "model": X.columns.get_values()[gamma], "elbo": elbo_vec}
    pickle.dump(neg_bin_simu, open("%s//negbin_ss_viem_boston_%d.pickle" % (folder, seed), "wb"), protocol=2)
